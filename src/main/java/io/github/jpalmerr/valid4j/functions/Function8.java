 ...
 * @param <H> the type of the seventh argument
 * @param <I> the type of the eighth argument
 * @param <R> the return type
 */
@FunctionalInterface
public interface Function8<A, B, C, D, F, G, H, I, R> {
  /**
   ...
   * @param h the seventh argument
   * @param i the eighth argument
   * @return the function result
   */
  R apply(A a, B b, C c, D d, F f, G g, H h, I i);
}
